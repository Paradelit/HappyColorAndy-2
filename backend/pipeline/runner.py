...
def generate_color_by_number(
    ...
    label_image, palette = quantize(rgb, n_colors=n_colors, clean_radius=clean_radius)
    region_map, region_color, region_area = segment(
    ...
    doc = assemble(w, h, palette, region_color, region_area, paths, labels)
    doc["meta"] = {
        "n_colors": n_colors,
